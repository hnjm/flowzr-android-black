...
public class BlotterListAdapter extends ResourceCursorAdapter {
    ...
    protected final Date dt = new Date();
...
//        }
    ...
    public static class BlotterViewHolder {
        ...
        public final TextView month_TV;
        ...
        public BlotterViewHolder(View view) {
            ...
            rightCenterView = (TextView) view.findViewById(R.id.right);
            rightView = (TextView) view.findViewById(R.id.right_center);
