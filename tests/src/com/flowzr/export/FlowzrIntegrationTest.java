...
import com.flowzr.test.DateTime;
...
public class FlowzrIntegrationTest extends InstrumentationTestCase {
    ...
    private final static String LAN_IP="192.168.1.4";
    ...
    public void test_push_accounts() throws Exception {
        if (dba.em().getAllAccounts().getCount()<1) {
            ...
            com.flowzr.model.Account a = new com.flowzr.model.Account();
        ...
        FlowzrSyncEngine.pushUpdate("account", com.flowzr.model.Account.class);
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                com.flowzr.model.Account a = dba.em().getAccount(cursor.getInt(cursor.getColumnIndex("_id")));
    ...
    public void test_pull_accounts() throws Exception {
        ...
        FlowzrSyncEngine.pullUpdate("account", com.flowzr.model.Account.class, 0);
        ...
        for (int i = 0; i < expect.length(); i++) {
            ...
            com.flowzr.model.Account c=dba.em().getAccount(id);
    ...
    public void test_push_rates() throws Exception {



        FlowzrSyncEngine.pushUpdate("currency_exchange_rate", ExchangeRate.class);

        JSONObject json = getJsonResponse(FlowzrSyncEngine.FLOWZR_API_URL + "admin_example.com/currency_exchange_rate/?last_sync_ts=0");
        JSONArray result = json.getJSONArray("currency_exchange_rate");
