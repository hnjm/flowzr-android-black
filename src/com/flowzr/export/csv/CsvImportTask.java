...
public class CsvImportTask extends ImportExportAsyncTask {
    ...
    public CsvImportTask(final BackupListActivity backupListActivity, Handler handler, ProgressDialog dialog, CsvImportOptions options) {
    ...
    protected Object work(Context context, DatabaseAdapter db, String... params) throws Exception {
        try {
            ...
            Log.e("Flowzr", "Csv import error", e);
