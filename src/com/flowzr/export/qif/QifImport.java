...
public class QifImport extends FullDatabaseImport {
    ...
    public void doImport() throws IOException {
        ...
        Log.i("Flowzr", "QIF Import: Parsing done in "+ TimeUnit.MILLISECONDS.toSeconds(t1-t0)+"s");
        doImport(parser);
        long t2 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Importing done in "+ TimeUnit.MILLISECONDS.toSeconds(t2-t1)+"s");
    }
    ...
    public void doImport(QifParser parser) {
        ...
        long t1 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Inserting payees done in " + TimeUnit.MILLISECONDS.toSeconds(t1 - t0) + "s");
        insertProjects(parser.classes);
        long t2 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Inserting projects done in "+ TimeUnit.MILLISECONDS.toSeconds(t2-t1)+"s");
        categoryCache.insertCategories(dbAdapter, parser.categories);
        long t3 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Inserting categories done in "+ TimeUnit.MILLISECONDS.toSeconds(t3-t2)+"s");
        insertAccounts(parser.accounts);
        long t4 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Inserting accounts done in "+ TimeUnit.MILLISECONDS.toSeconds(t4-t3)+"s");
        insertTransactions(parser.accounts);
        long t5 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Inserting transactions done in "+ TimeUnit.MILLISECONDS.toSeconds(t5-t4)+"s");
    }
    ...
    private void insertTransactions(List<QifAccount> accounts) {
        ...
        long t1 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Reducing transfers done in "+ TimeUnit.MILLISECONDS.toSeconds(t1-t0)+"s");
        convertUnknownTransfers(accounts);
        long t2 = System.currentTimeMillis();
        Log.i("Flowzr", "QIF Import: Converting transfers done in "+ TimeUnit.MILLISECONDS.toSeconds(t2-t1)+"s");
        ...
        for (int i=0; i<count; i++) {
            ...
            long t4 = System.currentTimeMillis();
            Log.i("Flowzr", "QIF Import: Inserting transactions for account "+i+"/"+count+" done in "+ TimeUnit.MILLISECONDS.toSeconds(t4-t3)+"s");
        }
    }
