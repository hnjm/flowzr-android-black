...
//	}
    ...
    private class GeocoderTask extends AsyncTask<Double, Void, String> {
        ...
        private GeocoderTask(MyLocation location) {
        	this.geocoder = new AddressGeocoder(LocationsListActivity.this.getActivity());
        ...
        protected void onPostExecute(String found) {
            ...
            if (found != null) {
				Toast t = Toast.makeText(LocationsListActivity.this.getActivity(), found, Toast.LENGTH_LONG);
				t.show();
				location.resolvedAddress = found;
				em.saveLocation(location);
				recreateCursor();
            } else if (geocoder.lastException != null) {
				Toast t = Toast.makeText(LocationsListActivity.this.getActivity(), R.string.service_is_not_available, Toast.LENGTH_LONG);
				t.show();            	
            }
