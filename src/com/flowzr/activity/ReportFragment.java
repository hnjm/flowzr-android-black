...
public class ReportFragment extends AbstractListFragment implements RefreshSupportedActivity {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
		...
		item.setIcon(filter.isEmpty() ? R.drawable.ic_menu_filter_off : R.drawable.ic_menu_filter_on);	
	...
	protected void viewItem(View v, int position, long id) {
		if (currentReport != null) {
			Intent intent = currentReport.createActivityIntent(this.getActivity(), db, WhereFilter.copyOf(filter), id);
