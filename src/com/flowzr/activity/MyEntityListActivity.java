...
public abstract class MyEntityListActivity<T extends MyEntity> extends AbstractListFragment {
	...
	protected void addItem() {
		Intent intent = new Intent(MyEntityListActivity.this.getActivity(), getEditActivityClass());
