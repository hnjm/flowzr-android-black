...
public class Criteria {
    ...
    public void toBundle(String title,Bundle bundle) {
    	bundle.putString(WhereFilter.TITLE_EXTRA, title);
    	bundle.putStringArray(WhereFilter.FILTER_EXTRA, new String[]{toStringExtra()});
    }
