...
//		t.longitude = c.getDouble(BlotterColumns.longitude.ordinal());
    ...
    public String toString() {
        ...
        sb.concat("FA(").concat(String.valueOf(fromAccountId)).concat(")->").concat(String.valueOf(fromAmount)).concat(",");
        sb.concat("TA(").concat(String .valueOf(toAccountId)).concat(")->").concat(String.valueOf(toAmount));
        return sb;
    }
