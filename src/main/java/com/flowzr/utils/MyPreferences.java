...
public class MyPreferences {
	...
	public static boolean useTodayForTotal(Context context) {
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
		return sharedPreferences.getBoolean("today_total", false);
	}
    ...
    public static void setFlowzrAccount(Context context, String accountName) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        sharedPreferences.edit().putString("flowzr_account", accountName).apply();
    }

    public static void unsetAutoSync(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        sharedPreferences.edit().putBoolean("auto_sync_enabled", false).apply();
    }
    ...
    public static String getSyncApiUrl(Context context) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        return sharedPreferences.getString("sync_api_url", null);
    }
    
    public static void setSyncApiUrl(Context context, String serverName) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        sharedPreferences.edit().putString("sync_api_url", serverName).apply();
    }
