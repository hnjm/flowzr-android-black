...
public class Report2DChartView extends View {
    ...
    private void init() {
		...
		currencyPaint.setTextSize(getResources().getDimension(R.dimen.report_legend_text_size));
    	
		amountPaint = new Paint();
		amountPaint.setAntiAlias(true);
		amountPaint.setColor(txtColor);
		amountPaint.setTextAlign(Align.LEFT);
		amountPaint.setTextSize(getResources().getDimension(R.dimen.report_legend_text_size));
