...
public class ReportActivity extends ListActivity implements RefreshSupportedActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (intent != null) {
            currentReport = ReportsListFragment.createReport(this, db.em(), intent.getExtras());
    ...
    protected void disableFilter() {
        ...
        bFilter.setImageResource(R.drawable.ic_filter_list);
    }

    protected void enableFilter() {
        bFilter.setEnabled(true);
        bFilter.setImageResource(filter.isEmpty() ? R.drawable.ic_filter_list : R.drawable.ic_menu_filter_on);
    }
